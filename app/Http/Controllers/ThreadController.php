...
class ThreadController extends \Riari\Forum\Http\Controllers\API\ThreadController
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $thread = $this->model()->create($request->only('author_id', 'title', 'content'));
