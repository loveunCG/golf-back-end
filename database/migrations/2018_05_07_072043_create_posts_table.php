...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Posts", 'posts', 'name', 'fa-cube', [
            ["name", "Post Name", "String", false, "", 0, 256, false],
            ["title", "Title", "String", false, "", 0, 256, false],
            ["description", "Description", "HTML", false, "", 0, 0, false],
            ["comments", "Comments", "Integer", false, "0", 0, 5000, false],
            ["likes", "Likes", "Integer", false, "0", 0, 5000, false],
            ["forum_id", "Forum", "Dropdown", false, "", 0, 0, true, "@forums"],
        ]);
