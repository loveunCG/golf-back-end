...
class CreatePlayitemsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Playitems", 'playitems', 'playlist_id', 'fa-music', [
            ["playlist_id", "Playlist Id", "Dropdown", false, "", 0, 0, false, "@playlists"],
            ["video_uid", "Video Id", "Dropdown", false, "", 0, 0, false, "@videos"],
        ]);
