...
@la_access("Academies", "create")
  ...
  <button class="tablinks btn btn-success btn-sm pull-left active" onclick="openLearning(event, 'Academy')">Academies</button>
  <button class="tablinks btn btn-success btn-sm pull-left" onclick="openLearning(event, 'Course')">Courses</button>
  <button class="tablinks btn btn-success btn-sm pull-left " onclick="openLearning(event, 'UniModule')">UniModules</button> 
