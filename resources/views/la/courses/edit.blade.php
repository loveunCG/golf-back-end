...
@section("htmlheader_title", "Courses Edit : ".$course->name)
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                {!! Form::model($course, ['route' => [config('laraadmin.adminRoute') . '.courses.update', $course->id ], 'method'=>'PUT', 'id' => 'course-edit-form', 'files' => true]) !!}
                ...
                <div class="form-group {{ $errors->has('featureimage') ? 'has-error' : ''}}">
                    ...
                    <image height="100" width="100" src="{{asset('storage').'/'.$course->featureimage}}" >  
                    <?php } ?>    
                    {!!Form::hidden('hidden_featureimage',$course->featureimage) !!}
                </div>
                <div class="form-group {{ $errors->has('academy_id') ? 'has-error' : ''}}">
                    {!! Form::label('academy_id', 'Academy') !!}
                    {!! Form::select('academy_id', $academies, $course->academy->id, array('class' => 'form-control')) !!}
                    ...
                    <div class="col-sm-12">
                        <div class="module-box">
                            <div class="form-group">
                                ...
                                {!! Form::text('modules[]', $module->name, array('class' => 'form-control')) !!}
                                {!! Form::hidden('hidden_total_modules_chapters[]', $module->chapters->count(), array('class' => 'total_items')) !!}
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="chap-vdo-box">							
                                        <div class="form-group">
                                            ...
                                            {!! Form::text('chapters[]', $chapter->name, array('class' => 'form-control')) !!}
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('videos', 'Videos') !!}
                                            @if($chapter->video)
                                                {!! Form::select('videos[]', $videos, $chapter->video->id, array('class' => 'form-control all-vids')) !!}
                                            @else
