			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'featureimage')
						@la_display($module, 'content')
						@la_display($module, 'modules_ids')
						@la_display($module, 'course_chapters')
						@la_display($module, 'course_skills')
						@la_display($module, 'course_video')
					</div>
				</div>
			</div>
		</div>
